...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Twig\\Components\\Counter' => 'getCounterService',
            'App\\Twig\\Components\\Search' => 'getSearchService',
            'App\\Twig\\Components\\Toast' => 'getToastService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\HomeController', 'App\\Twig\\Components\\Counter', 'App\\Twig\\Components\\Search', 'App\\Twig\\Components\\Toast', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['cache.ux.twig_component'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rZorJBmgdl', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))), ($container->privates['profiler.is_disabled_state_checker'] ?? self::getProfiler_IsDisabledStateCheckerService($container)));
    }
     ...
     */
    protected static function getUx_LiveComponent_ComponentHydratorService($container)
    {
    ...
    protected static function getUx_LiveComponent_MetadataFactoryService($container)
    {
        ...
        return $container->privates['ux.live_component.metadata_factory'] = new \Symfony\UX\LiveComponent\Metadata\LiveComponentMetadataFactory($a, $b, new \Symfony\Component\TypeInfo\TypeResolver\TypeResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    protected static function getUx_TwigComponent_ComponentFactoryService($container)
    {
        ...
        return $container->privates['ux.twig_component.component_factory'] = new \Symfony\UX\TwigComponent\ComponentFactory(new \Symfony\UX\TwigComponent\ComponentTemplateFinder(($container->privates['twig.loader.native_filesystem'] ?? self::getTwig_Loader_NativeFilesystemService($container)), 'components/'), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'Counter' => [false, 'App\\Twig\\Components\\Counter', 'getCounterService', true],
            'Search' => [false, 'App\\Twig\\Components\\Search', 'getSearchService', true],
            'Toast' => [false, 'App\\Twig\\Components\\Toast', 'getToastService', true],
        ], [
            'Alert' => '?',
            'Counter' => '?',
            'Search' => '?',
            'Toast' => '?',
        ]), ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), $a, ['Alert' => ['expose_public_props' => true, 'attributes_var' => 'attributes', 'key' => 'Alert', 'service_id' => 'App\\Twig\\Components\\Alert', 'class' => 'App\\Twig\\Components\\Alert', 'template' => 'components/Alert.html.twig', 'pre_mount' => [], 'mount' => [], 'post_mount' => []], 'Counter' => ['expose_public_props' => true, 'attributes_var' => 'attributes', 'live' => true, 'csrf' => true, 'route' => 'ux_live_component', 'method' => 'post', 'url_reference_type' => 1, 'key' => 'Counter', 'service_id' => 'App\\Twig\\Components\\Counter', 'class' => 'App\\Twig\\Components\\Counter', 'template' => 'components/Counter.html.twig', 'pre_mount' => [], 'mount' => [], 'post_mount' => []], 'Search' => ['expose_public_props' => true, 'attributes_var' => 'attributes', 'live' => true, 'csrf' => true, 'route' => 'ux_live_component', 'method' => 'post', 'url_reference_type' => 1, 'key' => 'Search', 'service_id' => 'App\\Twig\\Components\\Search', 'class' => 'App\\Twig\\Components\\Search', 'template' => 'components/Search.html.twig', 'pre_mount' => [], 'mount' => [], 'post_mount' => []], 'Toast' => ['expose_public_props' => true, 'attributes_var' => 'attributes', 'live' => true, 'csrf' => true, 'route' => 'ux_live_component', 'method' => 'post', 'url_reference_type' => 1, 'key' => 'Toast', 'service_id' => 'App\\Twig\\Components\\Toast', 'class' => 'App\\Twig\\Components\\Toast', 'template' => 'components/Toast.html.twig', 'pre_mount' => [], 'mount' => [], 'post_mount' => []]], ['App\\Twig\\Components\\Alert' => 'Alert', 'App\\Twig\\Components\\Counter' => 'Counter', 'App\\Twig\\Components\\Search' => 'Search', 'App\\Twig\\Components\\Toast' => 'Toast'], $b);
    }
